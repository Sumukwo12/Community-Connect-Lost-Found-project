...
export default function ReportLostPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Lost item reported successfully! (Demo mode)');
      navigate('/browse');
    } catch (error) {
  ...
  const handleSaveDraft = () => {
    ...
    localStorage.setItem('lostItemDraft', JSON.stringify(draftData));
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    onChange={handleInputChange}
                    className={errors.lastSeen ? 'border-red-500' : ''}
                    required 
                  />
                  {errors.lastSeen && <p className="text-red-500 text-xs">{errors.lastSeen}</p>}
                </div>
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    required 
                  />
                  {errors.dateLost && <p className="text-red-500 text-xs">{errors.dateLost}</p>}
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    {isDragOver ? 'Drop files here' : 'Click to upload or drag and drop photos of your lost item'}
                  </p>
